...
// scene 2:
var objects = [
    new Sphere(vec3(-.2, -.25, 1.5), .25, 
                vec4(.2, .2, .1, 1), vec4(.5, .5, .3, 1), vec4(1, 1, .8, 1),
                35),
    new Triangle(vec3(-.3, .9, 2.8), vec3(.7, -.3, 2.1), vec3(-.3, -.3, 2.8),
                vec4(.3, .3, .3, 1), vec4(.5, .5, .5, 1), vec4(1, 1, 1, 1),
                1000000),
    new Triangle(vec3(.7, .9, 2.1), vec3(.7, -.3, 2.1), vec3(-.3, .9, 2.8),
                vec4(.3, .3, .3, 1), vec4(.5, .5, .5, 1), vec4(1, 1, 1, 1),
                1000000)
];
